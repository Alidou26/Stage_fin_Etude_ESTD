...
<li>
<a href="parametres.php"  class="active"><img src="assets/img/icons/settings.svg" alt="img"><span>Paramètre</span> </a>
</li>
<li>
...
<form method="POST" id="admin" name="admins">
...
<label>Nom d'Utilisateur<span class="manitory">*</span></label>
<input type="text" name="pseudo" value="<?=$_SESSION['nom_utilisateur'] ?>" required>
</div>
</div>
<div class="col-lg-6 col-sm-12">
<div class="form-group">
<label>Nom<span class="manitory" required>*</span></label>
<input type="text" name="nom" value="<?=$_SESSION['nom'] ?>">
</div>
</div>
<div class="col-lg-6 col-sm-12">
<div class="form-group">
<label>Prénom<span class="manitory">*</span></label>
...
<input type="password" class=" pass-input" name="pwd1">
...
<div class="alert alert-success"   role="alert">
  Information Enregistrées avec succès!
</div>

<div class="alert alert-danger " id="erreur" role="alert"> Erreur..</div>

<div class="col-lg-12">
<button type="submit" form="admin" class="btn btn-submit me-2">Enregistrer</button>
...
<script src="assets/js/scriptparametre.js"></script>
